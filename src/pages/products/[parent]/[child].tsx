...
export default function Listing({ ...props }) {
  ...
  const buildQueryString = () => {
    ...
    params.append('subCategory', category._id);
...
export const getStaticPaths = async () => {
  ...
  const categories = await SubCategories.find({}).populate("parentCategory");

  const paths = categories.map((category) => ({
    params: { child: category.slug, parent: category.parentCategory.slug },
  }));
